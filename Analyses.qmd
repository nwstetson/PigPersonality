...
write.csv(behavior_counts, "~/Desktop/behavior_counts_Nov7.csv") # Convert to Excel file to magically add row numbers idk
```
...
Organize behaviors into categories

```{r}
ggplot(behavior_counts_wide, aes(x= Behavior, y= Count, group = PigName, color = PigName)) +
  geom_point() +
    theme_classic() +
  xlab("Behavior") +
  ylab("Counts") +

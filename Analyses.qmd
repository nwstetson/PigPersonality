...
```{r}
irr_sc1 <- read_csv("https://raw.githubusercontent.com/nwstetson/PigPersonality/main/irr_dfs/irr_sc1.csv", show_col_types = FALSE) #SC1
...
```{r}
irr_sc2 <- read_csv("https://raw.githubusercontent.com/nwstetson/PigPersonality/main/irr_dfs/irr_sc2.csv", show_col_types = FALSE) #SC1

kappa2(irr_sc2[,c(1,2)], "unweighted")

...
## This is the analysis for my undergraduate thesis on personality in pigs 🐷� �#### (currently using mock data for survey results because the actual one only has 7/40 surveys completed) 🙊
...
🐽 How do I set up the date frame for this?
...
## Replicability/Repeatability (idk) of Behaviors
